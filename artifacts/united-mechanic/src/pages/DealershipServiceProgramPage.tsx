          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl font-extrabold text-foreground mb-5">
                A Service Partner Your Dealership Can Rely On
              </h2>
            ...
            {[
              {
                ...
                desc: "Priority scheduling for dealership partners — we respect your reconditioning timelines.",
              },
              {
                icon: <DollarSign className="h-6 w-6" />,
                title: "Competitive Pricing",
                desc: "Volume-friendly rates with transparent invoicing — no hidden fees, ever.",
              },
              {
                icon: <ShieldCheck className="h-6 w-6" />,
                title: "Certified Quality",
                desc: "Every repair is performed by certified technicians using quality parts.",
              },
              {
                icon: <Car className="h-6 w-6" />,
                title: "Full-Service Capability",
                desc: "Mechanical, body shop, paint, and glass — one shop handles it all.",
              },
              {
                icon: <Users className="h-6 w-6" />,
                title: "Dedicated Contact",
                desc: "A direct line to our team — no being transferred or waiting in queues.",
              },
              {
                icon: <CheckCircle2 className="h-6 w-6" />,
                title: "Insurance Support",
                desc: "We handle all insurance coordination for collision and body work claims.",
              },
            ].map(({ icon, title, desc }) => (
              <motion.div
                key={title}
              ...
              >
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-accent text-primary mb-4">
                  {icon}
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              "Trade-in vehicle reconditioning",
              "Pre-delivery mechanical inspections",
              "Dent and scratch repair",
              "Auto painting and color matching",
              "Frame straightening and collision repair",
              "Windshield and glass replacement",
              "Brake, suspension, and engine repair",
              "Oil changes and routine maintenance",
              "Transmission service and repair",
              "Customer vehicle referral handling",
            ].map((item) => (
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-2xl md:text-4xl font-extrabold text-white mb-4">
              Interested in the Dealership Program?
            </h2>
            <p className="text-zinc-400 max-w-xl mx-auto mb-10 text-lg">
              Call us to discuss how My Ride Service Center can support your dealership's service needs.
            </p>
