...
export default function BodyShopListPage() {
  useEffect(() => {
    document.title = "Collision & Body Shop in Fredericksburg, VA | My Ride Service Center";
    ...
    const existing = document.getElementById("faq-schema-bs");
    ...
    return () => { document.getElementById("faq-schema-bs")?.remove(); };
  }, []);
      ...
      <section className="py-16 bg-zinc-50" aria-labelledby="bodyshop-services-heading">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 id="bodyshop-services-heading" className="text-2xl md:text-3xl font-extrabold text-foreground">
              Body Shop & Collision Repair Services in Fredericksburg, VA
            </h2>
            <p className="text-muted-foreground mt-3 max-w-2xl mx-auto text-sm md:text-base">
              From minor cosmetic damage to major structural collision repair — our body shop team restores every vehicle to the highest standard.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 id="about-bodyshop-heading" className="text-2xl md:text-3xl font-extrabold text-foreground mb-5">
                Factory-Quality Collision Repair — Not Just "Fixed"
              </h2>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                We work directly with all major insurance carriers, including State Farm, GEICO, Allstate, Progressive, and USAA. Our team handles the documentation, coordinates with adjusters, and keeps you informed through every stage of the repair — so the process is as stress-free as possible.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Every collision repair at My Ride Service Center is backed by a warranty on parts and labor. We don't release a vehicle until we're confident the repair meets the same standard as the original factory workmanship — and we invite you to inspect it before you drive away.
              </p>
            </div>
      ...
      <section className="py-16 bg-zinc-50" aria-labelledby="why-bodyshop-heading">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 id="why-bodyshop-heading" className="text-2xl md:text-3xl font-extrabold text-foreground">
              Why Fredericksburg Drivers Trust My Ride for Collision Repair
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[
              "Works with all major insurance companies",
              "Computerized frame straightening to factory specs",
              "Computer spectrophotometer color matching",
              "ADAS sensor recalibration after bumper and glass work",
              "Paintless dent removal — preserves factory paint",
              "Warranty on all collision repairs",
              "Free damage estimates",
              "OEM and OEM-equivalent replacement parts",
      ...
      <section className="py-16 bg-white" aria-labelledby="faq-bodyshop-heading">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10">
            ...
            <h2 id="faq-bodyshop-heading" className="text-2xl md:text-3xl font-extrabold text-foreground">
              Frequently Asked Questions About Collision Repair in Fredericksburg
            </h2>
          </div>
      ...
      <section className="py-20 bg-zinc-950">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-zinc-400 max-w-xl mx-auto mb-10 text-lg">
            We work with all major insurance companies to get your vehicle restored quickly and correctly. Call us today or book your free estimate online.
          </p>
