    ...
    <div className="min-h-screen bg-background font-sans">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-3xl font-extrabold text-foreground mb-5">Fredericksburg's Trusted Collision &amp; Auto Repair Experts</h2>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-white rounded-2xl border border-border p-6 text-center">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-10 text-lg">From AC repair to frame straightening — our team handles every type of vehicle repair with the same standard of quality.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/auto-repair">
                <Button size="lg" className="font-semibold w-full sm:w-auto">Auto Repair Services <ArrowRight className="ml-2 h-4 w-4" /></Button>
              </Link>
              <Link href="/body-shop">
                <Button size="lg" variant="outline" className="font-semibold border-primary text-primary hover:bg-primary hover:text-white w-full sm:w-auto">Body Shop Services <ArrowRight className="ml-2 h-4 w-4" /></Button>
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-zinc-950">
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-2xl md:text-4xl font-extrabold text-white mb-4">Come See Us in Fredericksburg</h2>
            <p className="text-zinc-400 max-w-xl mx-auto mb-10 text-lg">2715 Lafayette Blvd, Fredericksburg, VA 22408 — call us or book an appointment online.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
