  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <BoxedHero
        ...
        features={["Brake repair & replacement","Engine diagnostics & repair","Oil changes & fluid service","Transmission service"]}
      ...
      <section className="py-16 bg-zinc-50" aria-labelledby="services-heading">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 id="services-heading" className="text-2xl md:text-3xl font-extrabold text-foreground">Complete Auto Repair Services in Fredericksburg, VA</h2>
            <p className="text-muted-foreground mt-3 max-w-2xl mx-auto text-sm md:text-base">Every service is performed by trained technicians using quality parts — we cover everything your vehicle needs to run reliably and safely.</p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 id="about-repair-heading" className="text-2xl md:text-3xl font-extrabold text-foreground mb-5">Honest Auto Repair You Can Rely On</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">At My Ride Service Center, we believe auto repair should be straightforward and stress-free. Our technicians perform a thorough diagnosis before recommending any repair — so you understand exactly what's wrong and what it will cost before we touch your vehicle.</p>
              <p className="text-muted-foreground leading-relaxed mb-4">Serving Fredericksburg, Spotsylvania, Stafford, King George, and Culpeper counties, we're the area's go-to shop for everything from a simple oil change to a complex drivetrain repair.</p>
              <p className="text-muted-foreground leading-relaxed">We stand behind every repair with a warranty on parts and labor. If something isn't right, we make it right — no arguments, no excuses. That's the My Ride promise to every driver we serve.</p>
            </div>
      ...
      <section className="py-16 bg-white" aria-labelledby="faq-repair-heading">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10">
            ...
            <h2 id="faq-repair-heading" className="text-2xl md:text-3xl font-extrabold text-foreground">Frequently Asked Questions About Auto Repair in Fredericksburg</h2>
          </div>
      ...
      <section className="py-20 bg-zinc-950">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold text-white mb-4">Ready to Get Your Vehicle Fixed?</h2>
