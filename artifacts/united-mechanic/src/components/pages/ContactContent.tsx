          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.google.com/maps/search/2715+Lafayette+Blvd+Fredericksburg+VA+22408" target="_blank" rel="noreferrer" className="inline-block mt-2 text-primary text-sm font-medium hover:underline">
                        Get Directions →
                      </a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:5404186626" className="text-primary font-semibold hover:underline text-lg">540-418-6626</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1.5 text-sm text-muted-foreground">
                        <li className="flex justify-between gap-8"><span>Monday – Friday</span><span className="font-medium text-foreground">8:00 AM – 6:00 PM</span></li>
                        <li className="flex justify-between gap-8"><span>Saturday</span><span className="font-medium text-foreground">9:00 AM – 3:00 PM</span></li>
                        <li className="flex justify-between gap-8"><span>Sunday</span><span className="font-medium text-red-500">Closed</span></li>
                      </ul>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.facebook.com/profile.php?id=61583662515240" target="_blank" rel="noreferrer" className="text-[#1877F2] font-medium hover:underline">Facebook →</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className="space-y-6">
              <div className="bg-primary rounded-3xl p-8 text-white">
                ...
                <p className="text-white/80 mb-6 text-sm">Call us now or book an appointment online. Same-day service often available.</p>
              ...
              <div className="bg-zinc-50 rounded-3xl border border-border p-8">
                ...
                <p className="text-sm text-muted-foreground mb-4">From oil changes and brakes to transmission repair and engine diagnostics — we handle it all.</p>
                <Link href="/auto-repair">
                  <Button variant="outline" className="font-semibold border-primary text-primary hover:bg-primary hover:text-white">View Auto Repair →</Button>
                </Link>
              </div>
              <div className="bg-zinc-50 rounded-3xl border border-border p-8">
