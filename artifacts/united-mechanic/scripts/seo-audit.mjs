...
const requiredRoutes = [
  ...
  { path: "/auto-body-shop-fredericksburg-va/", titleIncludes: "Auto Body Shop Fredericksburg VA", canonical: `${siteUrl}/auto-body-shop-fredericksburg-va/` },
  { path: "/brake-repair-fredericksburg-va/", titleIncludes: "Brake Repair Fredericksburg VA", canonical: `${siteUrl}/brake-repair-fredericksburg-va/` },
  { path: "/oil-change-fredericksburg-va/", titleIncludes: "Oil Change Fredericksburg VA", canonical: `${siteUrl}/oil-change-fredericksburg-va/` },
  { path: "/suspension-repair-fredericksburg-va/", titleIncludes: "Suspension Repair Fredericksburg VA", canonical: `${siteUrl}/suspension-repair-fredericksburg-va/` },
  { path: "/dent-repair-fredericksburg-va/", titleIncludes: "Dent Repair Fredericksburg VA", canonical: `${siteUrl}/dent-repair-fredericksburg-va/` },
  { path: "/mechanic-fredericksburg-va/", titleIncludes: "Mechanic Fredericksburg VA", canonical: `${siteUrl}/mechanic-fredericksburg-va/` },
